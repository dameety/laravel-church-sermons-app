...
exports.default = {
    ...
    methods: {
        ...
        getAdminsCount: function getAdminsCount() {
            this.$http.get('/api/admins').then(function (response) {
        ...
        deleteAdmin: function deleteAdmin(admin) {
            ...
            swal({
                ...
                vm.$http.delete('/api/admin/delete/' + admin.slug).then(function () {
                    this.getAdminsCount();
...
exports.default = {
  ...
  methods: {
    ...
    addNewCategory: function addNewCategory() {
      ...
      this.$http.post('/api/category/new', category).then(function (response) {
        _this.fetchCategories();
        _this.getCategoriesCount();
      }, function (response) {
    ...
    saveUpdateCategory: function saveUpdateCategory(slug) {
      var categories = this.updateCategory;
      this.$http.patch('/api/category/' + slug, categories).then(function (response) {
        this.fetchCategories();
      });
    },
...
exports.default = {
        ...
        methods: {
                ...
                getPreachersCount: function getPreachersCount() {
                        this.$http.get('/api/preachers').then(function (response) {
                                this.preachersCount = response.body;
                        });
                },

                fetchPreachers: function fetchPreachers(page_url) {
                        var vm = this;
                ...
                addNewPreacher: function addNewPreacher() {
                        var _this = this;

                        var preacher = this.newPreacher;
                        this.newPreacher = { name: "", info: "" };
                        this.$http.post('/api/preacher/new', preacher).then(function (response) {
                                _this.fetchPreachers();
                                _this.getPreachersCount();
                        });
                },

                deletePreacher: function deletePreacher(preacher) {
                        var ConfirmBox = confirm('Are you sure you want to delete this preacher?');
                        if (ConfirmBox) {
                                this.$http.delete('/api/preacher/delete/' + preacher.name).then(function () {
                                        this.getPreachersCount();
...
exports.default = {
    ...
    methods: {
        ...
        getSermonsCount: function getSermonsCount() {
            this.$http.get('/api/sermons').then(function (response) {
        ...
        deleteSermon: function deleteSermon(sermon) {
            ...
            swal({
                ...
                vm.$http.delete('/api/sermon/delete/' + sermon.slug).then(function () {
                    this.getSermonsCount();
        ...
        detailsSermon: function detailsSermon(sermon) {
            ...
            this.$http.get('/api/sermoncategory/' + sermon.slug).then(function (response) {
                this.$set('oneSermonCategory', response.body);
            });
            this.$http.get('/api/sermonservice/' + sermon.slug).then(function (response) {
        ...
        saveUpdateSermon: function saveUpdateSermon(slug) {
            var sermon = this.updateSermon;
            this.$http.patch('/api/sermon/' + slug, sermon).then(function (response) {
        ...
        getAllServices: function getAllServices() {
            this.$http.get('/api/services').then(function (response) {
                this.services = response.body;
            });
        },

        getCategorySermons: function getCategorySermons(categorySelected) {
            var _this = this;

            this.$http.get('/api/' + categorySelected + '/sermons').then(function (response) {
                _this.$set('sermons', response.body);
            });
        }
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-2dc53029", module.exports)
  } else {
...
exports.default = {
  ...
  methods: {
    ...
    getServicesCount: function getServicesCount() {
      this.$http.get('/api/services').then(function (response) {
        this.servicesCount = response.body;
      });
    },

    fetchServices: function fetchServices(page_url) {
      var vm = this;
    ...
    addNewService: function addNewService() {
      ...
      this.$http.post('/api/service/new', service).then(function (response) {
        _this.fetchServices();
        _this.getServicesCount();
      }, function (response) {
        var errors = response.body;
        _this.formErrors = errors;
      });
    ...
    saveUpdateService: function saveUpdateService(slug) {
      var services = this.updateService;
      this.$http.patch('/api/service/' + slug, services).then(function (response) {
        this.fetchServices();
      });
    },
    ...
    methods: {
        ...
        deleteUser: function deleteUser(user) {
            ...
            swal({
                ...
                vm.$http.delete('/api/user/delete/' + user.slug).then(function () {
                    this.getUsersCount();
...
exports.default = {
  ...
  methods: {
    ...
    saveMessage: function saveMessage() {
      ...
      this.$http.post('/api/sermon/save', formData).then(function (response) {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-3534f579", module.exports)
  } else {
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n\t<div class=\"navigation-bar\">\n        <nav role=\"navigation\" class=\"navbar navbar-default\">\n            <!-- Brand and toggle get grouped for better mobile display -->\n            <div class=\"navbar-header\">\n                <button type=\"button\" data-target=\"#navbarCollapse\" data-toggle=\"collapse\" class=\"navbar-toggle\">\n                    <span class=\"sr-only\">Toggle navigation</span>\n                    <span class=\"icon-bar\"></span>\n                    <span class=\"icon-bar\"></span>\n                    <span class=\"icon-bar\"></span>\n                </button>\n                <a href=\"{{ route('userhome_path') }}\" class=\"navbar-brand\">ChurchSermons</a>\n            </div>\n            <div id=\"navbarCollapse\" class=\"collapse navbar-collapse\">\n                <ul class=\"nav navbar-nav\"></ul>\n                <ul class=\"nav navbar-nav navbar-right\">\n                    <li><a href=\"{{ url('/user/sermon/request') }}\"> <button type=\"button\" class=\"btn btn-primary\">Request A Sermon</button></a></li>\n                    <li @click.prevent=\"sermonRequest()\">Request A Sermon</li>\n                    <li><a href=\"{{ url('/user/profile') }}\"> <button type=\"button\" class=\"btn btn-primary\">Profile</button></a></li>\n                    <li><a href=\"{{ url('/logout') }}\"> <button type=\"button\" class=\"btn btn-danger\">Logout</button></a></li>\n                </ul>   \n            </div>\n        </nav>\n    </div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-0e227436", module.exports)
  } else {
    hotAPI.update("_v-0e227436", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"vue":24,"vue-hot-reload-api":22}],34:[function(require,module,exports){
'use strict';
...
var _allcategories = require('./components/allcategories.vue');

var _allcategories2 = _interopRequireDefault(_allcategories);

var _allusers = require('./components/allusers.vue');

var _allusers2 = _interopRequireDefault(_allusers);

var _newsermon = require('./components/newsermon.vue');

var _newsermon2 = _interopRequireDefault(_newsermon);

var _allpreachers = require('./components/allpreachers.vue');

var _allpreachers2 = _interopRequireDefault(_allpreachers);

var _allservices = require('./components/allservices.vue');

var _allservices2 = _interopRequireDefault(_allservices);

var _alladmins = require('./components/alladmins.vue');
...
var _usernav = require('./components/usernav.vue');
...
new Vue({
	...
	components: {
		...
		Allsermons: _allsermons2.default,
		...
		Usernav: _usernav2.default

	}

});

},{"./components/alladmins.vue":25,"./components/allcategories.vue":26,"./components/allpreachers.vue":27,"./components/allsermons.vue":28,"./components/allservices.vue":29,"./components/allusers.vue":30,"./components/newsermon.vue":31,"./components/sermoncards.vue":32,"./components/usernav.vue":33,"vue":24,"vue-resource":23}]},{},[34]);
